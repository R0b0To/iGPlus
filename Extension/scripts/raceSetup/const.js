...
export const circuits = {
  ...
  1: {
    ...
    ca: { ride: 4, wing: -1, suspension: -1, pit: 17 }, // Canada
    ...
    hu: { ride: 5, wing: 6, suspension: -1, pit: 17 }, // Hungary
    ...
    sg: { ride: 8, wing: 7, suspension: -1, pit: 20 }, // Singapore
  ...
  2: {
    ...
    at: { ride: 9, wing: 0, suspension: -1, pit: 27 }, // Austria
    ...
    bh: { ride: 8, wing: 0, suspension: -1, pit: 23 }, // Bahrain
    br: { ride: 8, wing: 5, suspension: -1, pit: 21 }, // Brazil
    ca: { ride: 9, wing: -3, suspension: -1, pit: 17 }, // Canada
    cn: { ride: 5, wing: 5, suspension: -1, pit: 26 }, // China
    de: { ride: 8, wing: 5, suspension: -1, pit: 17 }, // Germany
    es: { ride: 5, wing: 10, suspension: -1, pit: 25 }, // Spain
    eu: { ride: 12, wing: 10, suspension: -1, pit: 17 }, // Europe
    fr: { ride: 17, wing: 5, suspension: -1, pit: 20 }, // France
    gb: { ride: 9, wing: 0, suspension: -1, pit: 23 }, // Great Britain
    hu: { ride: 10, wing: 13, suspension: -1, pit: 17 }, // Hungary
    it: { ride: 12, wing: -5, suspension: -1, pit: 24 }, // Italy
    jp: { ride: 12, wing: 10, suspension: -1, pit: 20 }, // Japan
    ...
    sg: { ride: 17, wing: 14, suspension: -1, pit: 20 }, // Singapore
  ...
  3: {
    ...
    tr: { ride: 25, wing: 10, suspension: 10, pit: 18 }, // Turkey
