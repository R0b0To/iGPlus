...
export const circuits = {
  ...
  1: {
    ...
    bh: { ride: 4, wing: 0, suspension: 70, pit: 23 }, // Bahrain
    ...
    es: { ride: 2, wing: 5, suspension: 30, pit: 25 }, // Spain
    eu: { ride: 6, wing: 5, suspension: 0, pit: 17 }, // Europe
    fr: { ride: 8, wing: 2, suspension: 1, pit: 20 }, // France
    gb: { ride: 4, wing: 0, suspension: 70, pit: 23 }, // Great Britain
    hu: { ride: 5, wing: 6, suspension: 0, pit: 17 }, // Hungary
    it: { ride: 6, wing: -2, suspension: 90, pit: 24 }, // Italy
    jp: { ride: 6, wing: 5, suspension: 30, pit: 20 }, // Japan
    mc: { ride: 11, wing: 9, suspension: 0, pit: 16 }, // Monaco
    mx: { ride: 3, wing: 2, suspension: 1, pit: 19 }, // Mexico
    my: { ride: 6, wing: 1, suspension: 60, pit: 22 }, // Malaysia
  ...
  3: {
    ...
    at: { ride: 18, wing: 0, suspension: -1, pit: 27 }, // Austria
    ...
    sg: { ride: 33, wing: 27, suspension: -1, pit: 20 }, // Singapore
