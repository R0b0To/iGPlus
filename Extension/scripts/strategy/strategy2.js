...
const [fetcher, math, constants, utility] = await Promise.all([
    fetcherPromise, 
    mathPromise, 
    constPromise, 
    utilityPromise
...
const { cleanHtml } = utility;
    ...
    console.log(window.__igplus_strategy_state__.TRACK_INFO);
    console.log(window.__igplus_strategy_state__.CAR_ECONOMY);
    console.log(savedStrategy);
...
<div class="header-btn customSave">Save</div>
</div>
<div class="header-right">
<div class="header-btn settings-btn">Settings</div>
...
function initEvents (){
  ...
  console.log('adding',step,' to ',value);
    ...
    modal.innerHTML = `
      <div class="modal-content">
        ...
        <div class="modal-section">
          <div class="section-title">Push modifiers</div>
          ${PUSH_KEYS.map(k => `
        ...
        <div class="modal-section">
          <div class="section-title">Fuel efficiency (fe)</div>
  ...
  popup.innerHTML = `
    ...
    <div class="popup-panel">
      ...
      <div class="popup-section-preview">
        <button class="popup-save-btn"></button>
