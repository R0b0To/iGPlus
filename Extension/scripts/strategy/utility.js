...
async function createPreview(strategy,id,car_info){
  try {
    const {track_info, multipliers} = await import(chrome.runtime.getURL('scripts/strategy/const.js'));
...
function createDownloadButton()
{
  ...
  down_btn.classList.add('download-button','pushBtn');
  return down_btn;
}
...
<path d="M13 9H15V17H13V9Z" fill="currentColor" />
  ...
  deleteB.classList.add('trash','pushBtn');
  return deleteB;
}
